...
class CampanhasTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->allowEmptyString('unidade_sanitaria');

        $validator
            ->integer('brigada_movel')
            ->allowEmptyString('brigada_movel');

        $validator
            ->integer('agente_comunitario_saude')
            ->allowEmptyString('agente_comunitario_saude');

        $validator
            ->integer('intervalo_idade')
            ->allowEmptyString('intervalo_idade');

        $validator
            ->integer('mulhere_p_parto')
            ->allowEmptyString('mulhere_p_parto');
